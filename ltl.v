...
(* This file contains a parameterized specification of transitions systems  *)
(* with infinite states and transitions.                                    *)
(* It also contains the definitions of temporal time logic (LTL) operators  *)
(* and some safety and fairness related notions.                            *)
...
Variable state : Set.
Variable label : Set.
Variable init_state : state -> Prop.
Variable transition : label -> relation state.
Variable fair : label -> Prop.
